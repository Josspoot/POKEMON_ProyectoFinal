...
public class ReporteAtaque {
    ...
    public ReporteAtaque(String nombreAtacante, String nombreMovimiento,
                         int dmg, String nombreDefensor,
                         int hpRestante, boolean defensorDebilitado,
    ...
    public String getNombreDefensor()    { return nombreDefensor; }
    public int getHpRestante()           { return hpRestante; }
    public boolean isDefensorDebilitado(){ return defensorDebilitado; }
    public String getNombreSiguiente()   { return nombreSiguiente; }
}
