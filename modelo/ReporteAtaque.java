...
public class ReporteAtaque {
    ...
    public ReporteAtaque(String nombreAtacante, String nombreMovimiento, int dmg, String nombreDefensor, int hpRestante,
            boolean defensorDebilitado, String nombreSiguiente) {
